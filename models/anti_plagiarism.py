...
if __name__ == "__main__":
    ...
    dataset = AIOrHumanDataset("~/linguo-ml/data/ai_or_human/ai_human_detection_v1.csv")
    dataloader = get_dataloader("~/linguo-ml/data/ai_or_human/ai_human_detection_v1.csv")
